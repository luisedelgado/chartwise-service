...
class PromptCrafter:
    ...
    def _create_briefing_user_message(self,
        ...
        try:
            ...
            return (context_paragraph + execution_statement + language_params)
        except Exception as e:
            raise Exception(e)
    ...
    def _create_question_suggestions_system_message(self,
        ...
        try:
            ...
            If based on the context you find, you determine that there is no data associated with the patient for whatever reason, the "questions" array should be empty.
    ...
    def _create_frequent_topics_system_message(self, language_code: str) -> str:
        try:
            ...
            If based on the context you find, you determine that there is no data associated with the patient for whatever reason, the "topics" array should be empty.'''
    ...
    def _create_session_summary_user_message(self,
        ...
        try:
            ...
            return f'''Write a summary label for the session notes below. The session date was {session_date}.\nHere are the raw notes:\n\n{session_notes}.'''
        except Exception as e:
            raise Exception(e)

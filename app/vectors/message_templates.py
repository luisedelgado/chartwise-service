    ...
    def _create_question_suggestions_system_message(self,
        ...
        try:
            ...
            return (
                ...
                "Ensure that the questions reflect the exact data as presented, without any interpretation, assumptions, or diagnostic suggestions. "
                "The questions should be under 60 characters in length and focus on data points rather than clinical decision-making. "
                "Avoid broad or vague questions, as well as any questions that imply conclusions or recommendations. "
                "For example, a focused question would be 'What has the patient shared about his early childhood?'\n\n"

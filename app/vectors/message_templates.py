    ...
    def _create_briefing_system_message(self,
        ...
        try:
            ...
            return (
                    ...
                    "• **Historical Themes**: Use both the `pre_existing_history_summary` and the `chunk_summary` values to determine a set of relevant, historical themes for the patient. "
    ...
    def _create_question_suggestions_system_message(self,
        ...
        try:
            ...
            return (
                ...
                "Your task is to generate two specific questions that the practitioner might ask, based solely on the information in the `chunk_summary` and `pre_existing_history_summary` values. "

...
class PromptCrafter:
    ...
    def _create_qa_system_message(self,
        ...
        return (
            ...
            f"4. Additionally, if a `pre_existing_history_summary` is relevant to the question, include the `pre_existing_history_text` in your response, as it describes {patient_name}'s history before joining the platform. Mention also that the information in your response came from the patient's pre-existing history.\n"
